                ...
                <?php
                    if(isset($_COOKIE['user_cart'])){
                        ...
                        <?php    } ?>
                                ...
                                <!-- <a class="btn btn-sm btn-primary" href="instamojo.php?product_total=<?php echo $row['product_price']   ;?>" >Continue Shopping</a> -->
                                ...
                                <form action="instamojo.php" class="checkout-form pull-right" method="POST" >
                                    ...
                                    <input class="btn btn-lg btn-primary" name="submit" type="submit" id="submit"  placeholder="submit">
                                </form>
                                <?php }else{ ?>
